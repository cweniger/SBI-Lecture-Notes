...
\medskip
These three approaches correspond to modifying the simulator, the representation, or the update rule.  In the remainder of this section we focus on \emph{robust summary learning}, which may offer the most principled path to asymptotic correctness.
