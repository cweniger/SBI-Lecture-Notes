...
\begin{description}
\item[Chapter 1 (Foundations)] establishes the conceptual groundwork, contrasting simulation-based and likelihood-based inference, introducing ABC, and developing information-theoretic perspectives on data compression and summary statistics.

\item[Chapter 2 (Neural Methods)] presents the main algorithmic approaches—NPE, NLE, and NRE—emphasizing their information-theoretic interpretations, architectural requirements, and practical trade-offs.

\item[Chapter 3 (Diagnostics)] provides an extensive treatment of validation methods organized around the taxonomy of epistemic uncertainties. We discuss reference posterior comparisons, forward-backward diagnostics (SBC, coverage tests, C2ST), model-based rank diagnostics, and model misspecification tests.

\item[Chapter 4 (Advanced Topics)] explores robust inference under simulator uncertainty, formalizing asymptotic notions of robustness and presenting strategies for learning invariant summaries.

\item[Chapter 5 (Concluding Remarks)] offers perspective on the future of the field and additional resources.
\end{description}
...
The design and writing of these lecture notes were supported by large language models (Claude by Anthropic, ChatGPT by OpenAI, and Gemini by Google). LLMs were used to help in structuring material, refining exposition, conducting literature-based and conceptual exploration of ideas, and generating example code, figures, and LaTeX formatting.  All scientific perspectives, conceptual frameworks, synthesis decisions, and pedagogical choices reflect my own understanding and judgment---both about the science and about what approaches will best serve our research field moving forward. 
}
