...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/fig_coverage.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/fig_coverage_shape_distortion.pdf}
...
\begin{figure}[t]
    ...
    \includegraphics[width=\linewidth]{figures/fig_coverage_likelihood_based.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/fig_grd_illustration.pdf}
    \caption{Generalized Rank Diagnostics with different ordering functions, corresponding to various standard tests.}
    \label{fig:grd_illustration}
\end{figure}
...
\cw{Fix above equation}

\cw{something like: TARP can be viewed as simulation-based calibration applied to a randomized family of ordering functions. This substantially increases sensitivity to joint and geometric distortions compared to fixed orderings, but—like SBC—remains a rank-based diagnostic and is therefore not sufficient to certify posterior correctness.
}

\cw{TARP can be viewed as simulation-based calibration applied to a randomized family of ordering functions. While this increases sensitivity to certain joint distortions, it also averages over many distinct rank tests, making the effective weighting over parameter space implicit and difficult to interpret. As a result, TARP may be less informative than targeted SBC diagnostics when the goal is to understand the nature of posterior discrepancies rather than merely detect them.}
